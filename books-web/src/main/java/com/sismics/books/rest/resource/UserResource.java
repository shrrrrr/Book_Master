...
public class UserResource extends BaseResource {
    ...
    public Response register(
        ...
        return userService.register(username,password,localeId,email);
    }
    ...
    //     System.out.println(password + " | " + email + " | " + themeId + " | " +firstConnection);
    //     DefaultUserService userService = new DefaultUserService();
    //     return userService.update(password,email,themeId,localeId,firstConnection);
    ...
    public Response update(
        ...
        DefaultUserService userService = new DefaultUserService();
        return userService.update(username,password,email,themeId,localeId);   
    }
    ...
    public Response login(
     ...
     DefaultUserService userService = new DefaultUserService();
        return userService.login(username,password,longLasted);
    }
