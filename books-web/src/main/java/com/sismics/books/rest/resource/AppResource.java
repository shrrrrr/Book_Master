...
public class AppResource extends BaseResource {
    ...
    public Response info() throws JSONException {
        ...
        JSONObject response = createAppInfoResponse();
    ...
    public Response update(
        ...
        validateAndUpdateConfig(apiKeyGoogle);
       
        JSONObject response = createUpdateResponse();
        return Response.ok().entity(response).build();
    }
    ...
    public Response log(
        ...
        JSONObject response = retrieveLogs(level, tag, message, limit, offset);
    ...
    private JSONObject createAppInfoResponse() throws JSONException {
    ...
    private void validateAndUpdateConfig(String apiKeyGoogle) throws JSONException {
    ...
    private JSONObject createUpdateResponse() throws JSONException {
        JSONObject response = new JSONObject();
        response.put("status", "ok");
        return response;
    }
   
    private JSONObject retrieveLogs(String level, String tag, String message, Integer limit, Integer offset) throws JSONException {
