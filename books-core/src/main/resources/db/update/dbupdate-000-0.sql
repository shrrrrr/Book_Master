...
CREATE CACHED TABLE T_LIBRARY_BOOK (BOK_ID_C VARCHAR(36) NOT NULL,BOK_TITLE_C VARCHAR(255) NOT NULL,BOK_SUBTITLE_C VARCHAR(255),BOK_AUTHOR_C VARCHAR(255) NOT NULL,BOK_DESCRIPTION_C VARCHAR(4000),BOK_ISBN10_C VARCHAR(10),BOK_ISBN13_C VARCHAR(13),BOK_PAGECOUNT_N INTEGER,BOK_LANGUAGE_C VARCHAR(2),BOK_PUBLISHDATE_D DATETIME,BOK_RATING INTEGER,BOK_UPLOADEDBY VARCHAR(255),BOK_RATINGS VARCHAR(255),BOK_GENRE varchar(36),PRIMARY KEY (BOK_ID_C));
CREATE CACHED TABLE T_RATING (id VARCHAR(36) PRIMARY KEY,user_id VARCHAR(36) NOT NULL,book_id VARCHAR(36) NOT NULL,rating VARCHAR(255) NOT NULL);
CREATE CACHED TABLE T_REGISTERED (id VARCHAR(36) PRIMARY KEY);
...
create cached table T_FAVOURITE (FAV_ID varchar(36),USER_ID VARCHAR(255) not null, SERVICE_PROVIDER VARCHAR(50)  ,CONTENT_TYPE VARCHAR(50) ,ITEM_NAME VARCHAR(50),AUTHOR_NAME VARCHAR(50),primary key (ITEM_NAME));
